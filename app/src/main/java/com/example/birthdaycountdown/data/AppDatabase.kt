...
@Database(entities = [CountdownEntity::class, WatchCategoryEntity::class, WatchRecordEntity::class, WatchStatusEntity::class, AiConversationEntity::class, AiMessageEntity::class], version = 18, exportSchema = false)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_17_18 = object : Migration(17, 18) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE countdown_records ADD COLUMN useCustomCardColors INTEGER NOT NULL DEFAULT 1")
            }
        }
    }
}
