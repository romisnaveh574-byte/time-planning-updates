...
- Added an Android instrumentation migration test which creates a version-16-shaped `watch_records` table, inserts every legacy status ID, runs the migration, and verifies both seeded statuses and preserved record values.
